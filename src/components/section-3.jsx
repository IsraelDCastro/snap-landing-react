      ...
      <>
        <section className={`section-3 ${bgSelected}`}>
            { 
              ...
              this.state.selectedPlace === "Osaka" ?
                <div className="place-information fadeIn" data-start>
                  ...
                  <p className="mb-10 text-shadow">Osaka is a large port city and commercial center on the Japanese island of Honshu. It's known for its modern architecture, nightlife and hearty street food. The 16th-century shogunate Osaka Castle, which has undergone several restorations, is its main historical landmark. It's surrounded by a moat and park with plum, peach and cherry-blossom trees. Sumiyoshi-taisha is among Japan’s oldest Shinto shrines.</p>
              ...
              this.state.selectedPlace === "Arashiyama" ?
                <div className="place-information fadeIn" data-start>
                  ...
                  <p className="mb-10 text-shadow">The walking paths that cut through the bamboo groves make for a nice walk or bicycle ride. The groves are particularly attractive when there is a light wind and the tall bamboo stalks sway gently back and forth. The bamboo has been used to manufacture various products, such as baskets, cups, boxes and mats at local workshops for centuries.</p>
          ...
          <div className="places">
            <div className="place placeDown place-delay-3" data-start onClick={ () => this.changePlace("Fujiyoshida")}>
            ...
            <div className="place placeDown place-delay-2" data-start onClick={ () => this.changePlace("Osaka")}>
            ...
            <div className="place placeDown" data-start onClick={ () => this.changePlace("Arashiyama")}>
